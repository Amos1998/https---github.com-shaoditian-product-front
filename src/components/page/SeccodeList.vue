    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item> <i class="el-icon-lx-cascades"></i> 验证码列表 </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                <el-button type="primary" icon="el-icon-delete" class="handle-del mr10" @click="delAllSelection">批量删除</el-button>
                <el-input v-model="query.phoneNumber" placeholder="手机号码" class="handle-input mr10"></el-input>
                <el-date-picker
                    type="date"
                    placeholder="选择日期"
                    v-model="query.date"
            ...
            >
                ...
                <el-table-column prop="secco" label="验证码" align="center"></el-table-column>
                ...
                <el-table-column label="操作" min-width="200" align="center">
                    <template slot-scope="scope">
                        ...
                        <!-- <el-button type="warning " icon="el-icon-info">禁用</el-button>
                        <el-button type="success " icon="el-icon-view">审核</el-button> -->
...
export default {
    ...
    methods: {
        // 获取 easy-mock 的模拟数据
        getData() {
            fetchData(this.query, 4).then(res => {
